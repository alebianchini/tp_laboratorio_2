...
namespace Entidades
{
    public class ArticuloPedido<T> where T : Producto
    {
        int cantidad;
        public T producto;
        double precioFinal;
        ...
        /// <summary>
        /// Constructor con todos los atributos de un AticuloPedido.
        /// </summary>
        /// <param name="cantidad"></param>
        /// <param name="producto"></param>
        /// <param name="precioFinal"></param>
        /// <param name="precioUnitario"></param>
        public ArticuloPedido(int cantidad, T producto, double precioFinal, double precioUnitario)
        {
        ...
        /// <summary>
        /// Convierte los datos de un ArticuloPedido en un string
        /// </summary>
        /// <returns>Retorna un string formateado con todos los datos de un ArticuloPedido</returns>
